...
![データの読み込み](https://github.com/Kojiro-Nakamura/hoanrin-hanrei-sakuzu/raw/master/docs/images/open-file.webp)
...
3. 続けて、必要に応じて右上の **「TIF背景」** ボタンをクリックして、ALANDIS地図から出力した地図のTIFFファイルを含んだZIPを読み込むことで、図面の背景に表示させることができます。
